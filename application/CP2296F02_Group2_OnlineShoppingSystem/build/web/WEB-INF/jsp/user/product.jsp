                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            <li class="page-item" id="hideLi">
                                ...
                                <a class="page-link" href="${pageContext.request.contextPath}/user/showproductpage?cId=${categoryId}&page=${page-1}" aria-label="Previous">
                            ...
                            <c:forEach var="item" items="${sizeOfList}">
                                <li class="page-item <c:if test="${page==item.index}">
                                    ...
                                    <a  class="page-link" href="${pageContext.request.contextPath}/user/showproductpage?cId=${categoryId}&page=${item.index}">${item.index}</a></li>
                                </c:forEach>                         
                            <li class="page-item" id="hideLi1">
                                <div id="disable1"></div>
                                <a class="page-link" href="${pageContext.request.contextPath}/user/showproductpage?cId=${categoryId}&page=${page+1}" aria-label="Next">
